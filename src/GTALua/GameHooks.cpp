...
void GameMemory::InstallHooks()
{
	...
	// ScriptEngine::Init
	DWORD64 pScriptEngine = Find((PBYTE)"\x48\x89\x5C\x24\x00\x57\x48\x83\xEC\x20\x33\xFF\x48\x8B\xD9\x66\x89\x39\x48\x89\x79\x04", "xxxx?xxxxxxxxxxxxxxxxx");
	Memory::HookFunction(pScriptEngine, &ScriptEngine__Init, (void**)&pScriptEngine__Init);
	printf("Hooking ScriptEngine    : %016llx\n", pScriptEngine);
}
