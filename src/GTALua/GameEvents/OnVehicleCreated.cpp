...
{
	// OnVehicleCreated
	printf("Hooking OnVehicleCreated: ");
	DWORD64 pOnVehicleCreated = GameMemory::Find((PBYTE)"\x48\x8B\xC4\x48\x89\x58\x08\x48\x89\x70\x18\x48\x89\x78\x20\x55\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8D\x68\xB9", "xxxxxxxxxxxxxxxxxxxxxxxxxxxx");
	printf("%016llx\n", pOnVehicleCreated);
	Memory::HookFunction(pOnVehicleCreated, &World__CreateVehicle, (void**)&pWorld_CreateVehicle);
}