...
{
	// OnPedCreated
	printf("Hooking OnPedCreated    : ");
	DWORD64 pOnPedCreated = GameMemory::Find((PBYTE)"\x48\x8B\xC4\x48\x89\x58\x08\x48\x89\x68\x10\x48\x89\x78\x18\x41\x55", "xxxxxxxxxxxxxxxxx");
	printf("%016llx\n", pOnPedCreated);
	Memory::HookFunction(pOnPedCreated, &World__CreatePed, (void**)&pWorld_CreatePed);
}