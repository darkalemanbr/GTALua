...
namespace VEHICLE
{
	...
	static void _GET_VEHICLE_DASHBOARD_COLOR(Vehicle vehicle, int *color) { invoke<Void>(0xB7635E80A5C31BFF, vehicle, color); } // 0xB7635E80A5C31BFF
	static void _SET_VEHICLE_DASHBOARD_COLOR(Vehicle vehicle, int color) { invoke<Void>(0x6089CDF6A57F326C, vehicle, color); } // 0x6089CDF6A57F326C
	static void _GET_VEHICLE_INTERIOR_COLOR(Vehicle vehicle, int *color) { invoke<Void>(0x7D1464D472D32136, vehicle, color); } // 0x7D1464D472D32136
	static void _SET_VEHICLE_INTERIOR_COLOR(Vehicle vehicle, int color) { invoke<Void>(0xF40DD601A65F7F19, vehicle, color); } // 0xF40DD601A65F7F19
}
