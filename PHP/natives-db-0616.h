...
namespace NETWORK
{
	...
	static BOOL NETWORK_IS_FRIEND_IN_SAME_TITLE(int* player) { return invoke<BOOL>(0x2EA9A3BEDF3F17B8, player); } // 0x2EA9A3BEDF3F17B8 0xC54365C2
	static BOOL NETWORK_IS_FRIEND_IN_MULTIPLAYER(int* player) { return invoke<BOOL>(0x57005C18827F3A28, player); } // 0x57005C18827F3A28 0x400BDDD9
	...
	static BOOL NETWORK_CLAN_JOIN(Any clanHandle) { return invoke<BOOL>(0x9FAAA4F4FC71F87F, clanHandle); } // 0x9FAAA4F4FC71F87F 0x79C916C5
