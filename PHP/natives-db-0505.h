...
namespace VEHICLE
{
	...
	static void _TASK_BRING_VEHICLE_TO_HALT(Vehicle vehicle, float x, float y, float z) { invoke<Void>(0x260BE8F09E326A20, vehicle, x, y, z); } // 0x260BE8F09E326A20 0xCBC7D3C8
