...
namespace PED
{
	...
	static int CREATE_SYNCHRONIZED_SCENE(float x, float y, float z, float p3, float p4, float p5, Any p6) { return invoke<int>(0x8C18E0F9080ADD73, x, y, z, p3, p4, p5, p6); } // 0x8C18E0F9080ADD73 0xFFDDF8FA
	...
	static void ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(int scene, Entity entity, int boneIndex) { invoke<Void>(0x272E4723B56A3B96, scene, entity, boneIndex); } // 0x272E4723B56A3B96 0xE9BA6189
...
namespace AI
{
	...
	static void TASK_VEHICLE_MISSION_PED_TARGET(Ped ped, Vehicle vehicle, Ped p2, int mode, float maxSpeed, Any p5, float p6, float p7, BOOL p8) { invoke<Void>(0x9454528DF15D657A, ped, vehicle, p2, mode, maxSpeed, p5, p6, p7, p8); } // 0x9454528DF15D657A 0xC81C4677
	...
	static void TASK_HELI_MISSION(Ped pilot, Vehicle vehicle, Any p2, Ped pedToFollow, float posX, float posY, float posZ, int flag, float speed, float radius, float angle, int p11, int height, float p13, int p14) { invoke<Void>(0xDAD029E187A2BEB4, pilot, vehicle, p2, pedToFollow, posX, posY, posZ, flag, speed, radius, angle, p11, height, p13, p14); } // 0xDAD029E187A2BEB4 0x0C143E97
...
namespace PATHFIND
{
	...
	static int GET_NTH_CLOSEST_VEHICLE_NODE_ID(float x, float y, float z, int nth, Any nodetype, float p5, float p6) { return invoke<int>(0x22D7275A79FE8215, x, y, z, nth, nodetype, p5, p6); } // 0x22D7275A79FE8215 0x3F358BEA
...
namespace WATER
{
	...
	static void _SET_WAVE_HEIGHT(float p0) { invoke<Void>(0xB96B00E976BE977F, p0); } // 0xB96B00E976BE977F
	static float _GET_WAVE_HEIGHT() { return invoke<float>(0x2B2A2CC86778B619); } // 0x2B2A2CC86778B619
...
namespace NETWORK
{
	...
	static int _BC1D768F2F5D6C05(Player player) { return invoke<int>(0xBC1D768F2F5D6C05, player); } // 0xBC1D768F2F5D6C05
