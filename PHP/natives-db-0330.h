...
namespace GRAPHICS
{
	...
	static BOOL _0x98C4FE6EC34154CA(char* p0, Ped ped, int p2, float xPos, float yPos, float zPos) { return invoke<BOOL>(0x98C4FE6EC34154CA, p0, ped, p2, xPos, yPos, zPos); } // 0x98C4FE6EC34154CA 0x9A0E3BFE
