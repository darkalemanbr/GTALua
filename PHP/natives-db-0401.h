...
namespace VEHICLE
{
	...
	static void SET_VEHICLE_ENGINE_HEALTH(Vehicle vehicle, float false) { invoke<Void>(0x45F6D8EEF34ABEF1, vehicle, false); } // 0x45F6D8EEF34ABEF1 0x1B760FB5
...
namespace NETWORK
{
	...
	static void NETWORK_HANDLE_FROM_PLAYER(Player player, Any* buffer, int bufferSize) { invoke<Void>(0x388EB2B86C73B6B3, player, buffer, bufferSize); } // 0x388EB2B86C73B6B3 0xD3498917
	...
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Any p0, Any p1, char* p2, char* p3, float p4, float p5, int p6, Any p7, float p8, Any p9) { invoke<Void>(0x742A637471BCECD9, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0x742A637471BCECD9 0xB386713E
	static void NETWORK_ADD_ENTITY_TO_SYNCHRONISED_SCENE(Any p0, Any p1, char* p2, char* p3, float p4, float p5, Any p6) { invoke<Void>(0xF2404D68CBC855FA, p0, p1, p2, p3, p4, p5, p6); } // 0xF2404D68CBC855FA 0x10DD636C
	static void _0xCF8BD3B0BD6D42D7(Any p0, char* p1, char* p2) { invoke<Void>(0xCF8BD3B0BD6D42D7, p0, p1, p2); } // 0xCF8BD3B0BD6D42D7 0xBFFE8B5C
