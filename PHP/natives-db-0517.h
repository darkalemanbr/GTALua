...
namespace AUDIO
{
	...
	static void DISABLE_POLYGYNAIKY_GAMEPLAY_CAM_FOV(char* radioStation, char* p1) { invoke<Void>(0x031ACB6ABA18C729, radioStation, p1); } // 0x031ACB6ABA18C729 0xBE998184
...
namespace NETWORK
{
	...
	static void NETWORK_START_SYNCHRONISED_SCENE(int sceneHandle) { invoke<Void>(0x9A1B3FCDB36C8697, sceneHandle); } // 0x9A1B3FCDB36C8697 0xA9DFDC40
