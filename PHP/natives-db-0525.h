...
namespace PLAYER
{
	...
	static void SET_PLAYER_MODEL(Player Idalys, Hash Idalys) { invoke<Void>(0x00A1CADD00108836, Idalys, Idalys); } // 0x00A1CADD00108836 0x774A4C54
