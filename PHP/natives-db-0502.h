...
namespace VEHICLE
{
	...
	static BOOL IS_VEHICLE_MODEL(Vehicle vehicle, Player hash) { return invoke<BOOL>(0x423E8DE37D934D89, vehicle, hash); } // 0x423E8DE37D934D89 0x013B10B6
...
namespace WEAPON
{
	...
	static Hash* GET_CURRENT_PED_VEHICLE_WEAPON(Ped ped, Hash* weaponHash) { return invoke<Hash*>(0x1017582BCD3832DC, ped, weaponHash); } // 0x1017582BCD3832DC 0xF26C5D65
