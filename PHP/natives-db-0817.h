...
namespace PED
{
	...
	static void _ASSIGN_PED_TO_PED(Ped ped1, Ped ped2) { invoke<Void>(0xE952D6431689AD9A, ped1, ped2); } // 0xE952D6431689AD9A 0xFC70EEC7
...
namespace STREAMING
{
	...
	static int* HAS_ANIM_SET_LOADED(char* animSet) { return invoke<int*>(0xC4EA073D86FB29B0, animSet); } // 0xC4EA073D86FB29B0 0x4FFF397D
