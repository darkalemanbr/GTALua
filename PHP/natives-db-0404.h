...
namespace PLAYER
{
	...
	static void DISPLAY_SYSTEM_SIGNIN_UI(BOOL display) { invoke<Void>(0x94DD7888C10A979E, display); } // 0x94DD7888C10A979E 0x4264CED2
...
namespace PED
{
	...
	static void SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_PED(Any p0, Any p1, float p2, float p3, float p4, float p5, BOOL p6) { invoke<Void>(0xF9B8F91AAD3B953E, p0, p1, p2, p3, p4, p5, p6); } // 0xF9B8F91AAD3B953E 0x40638BDC
...
namespace VEHICLE
{
	...
	static void SET_VEHICLE_ENGINE_ON(Vehicle vehicle, BOOL true, BOOL true, BOOL false) { invoke<Void>(0x2497C4717C8B881E, vehicle, true, true, false); } // 0x2497C4717C8B881E 0x7FBC86F1
	...
	static void SET_VEHICLE_TYRE_SMOKE_COLOR(Vehicle false, int r, int g, int b) { invoke<Void>(0xB5BA80F839791C0F, false, r, g, b); } // 0xB5BA80F839791C0F 0x3EDEC0DB
	...
	static BOOL _IS_VEHICLE_ENGINE_ON(Vehicle false) { return invoke<BOOL>(0xAE31E7DF9B5B132E, false); } // 0xAE31E7DF9B5B132E 0x7DC6D022
	...
	static void SET_VEHICLE_CAN_BE_USED_BY_FLEEING_PEDS(Vehicle vehicle, BOOL p1) { invoke<Void>(0x300504B23BD3B711, vehicle, p1); } // 0x300504B23BD3B711 0x5130DB1E
...
namespace CUTSCENE
{
	...
	static Entity GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY(Any* p0, Any p1) { return invoke<Entity>(0x0A2E9FDB9A8C62F6, p0, p1); } // 0x0A2E9FDB9A8C62F6 0x1D09ABC7
	...
	static Entity GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(Any* p0, Any p1) { return invoke<Entity>(0xC0741A26499654CD, p0, p1); } // 0xC0741A26499654CD 0x46D18755
	...
	static void SET_CUTSCENE_PED_PROP_VARIATION(Any* p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x0546524ADE2E9723, p0, p1, p2, p3, p4); } // 0x0546524ADE2E9723 0x22E9A9DE
...
namespace UI
{
	...
	static Any GET_BLIP_INFO_ID_ENTITY_INDEX(Blip blip) { return invoke<Any>(0x4BA4E2553AFEDC2C, blip); } // 0x4BA4E2553AFEDC2C 0xA068C40B
	static Any GET_BLIP_INFO_ID_PICKUP_INDEX(Blip blip) { return invoke<Any>(0x9B6786E4C03DD382, blip); } // 0x9B6786E4C03DD382 0x86913D37
	...
	static Blip ADD_BLIP_FOR_PICKUP(Any p0) { return invoke<Blip>(0xBE339365C863BD36, p0); } // 0xBE339365C863BD36 0x16693C3A
...
namespace GRAPHICS
{
	...
	static int CREATE_CHECKPOINT(int type, float xPos1, float yPos1, float zPos1, float xPos2, float yPos2, float zPos2, float radius, int r, int g, int b, int alpha, int number) { return invoke<int>(0x0134F0835AB6BFCB, type, xPos1, yPos1, zPos1, xPos2, yPos2, zPos2, radius, r, g, b, alpha, number); } // 0x0134F0835AB6BFCB 0xF541B690
...
namespace PATHFIND
{
	static void SET_ROADS_IN_AREA(float* x2, float y1, float z1, float x2, float y2, Player z2, BOOL unknown1, BOOL unknown2) { invoke<Void>(0xBF1A602B5BA52FEE, x2, y1, z1, x2, y2, z2, unknown1, unknown2); } // 0xBF1A602B5BA52FEE 0xEBC7B918
...
namespace CONTROLS
{
	static BOOL IS_CONTROL_ENABLED(int controlGroup, int control) { return invoke<BOOL>(0x1CEA6BFDF248E5D9, controlGroup, control); } // 0x1CEA6BFDF248E5D9 0x9174AF84
	static BOOL IS_CONTROL_PRESSED(int controlGroup, int control) { return invoke<BOOL>(0xF3A21BCD95725A4A, controlGroup, control); } // 0xF3A21BCD95725A4A 0x517A4384
	static BOOL IS_CONTROL_RELEASED(int controlGroup, int control) { return invoke<BOOL>(0x648EE3E7F38877DD, controlGroup, control); } // 0x648EE3E7F38877DD 0x1F91A06E
	static BOOL IS_CONTROL_JUST_PRESSED(int controlGroup, int control) { return invoke<BOOL>(0x580417101DDB492F, controlGroup, control); } // 0x580417101DDB492F 0x4487F579
	static BOOL IS_CONTROL_JUST_RELEASED(int controlGroup, int control) { return invoke<BOOL>(0x50F940259D3841E6, controlGroup, control); } // 0x50F940259D3841E6 0x2314444B
	static int GET_CONTROL_VALUE(int controlGroup, int control) { return invoke<int>(0xD95E79E8686D2C27, controlGroup, control); } // 0xD95E79E8686D2C27 0xC526F3C6
	static float GET_CONTROL_NORMAL(int controlGroup, int control) { return invoke<float>(0xEC3C9B8D5327B563, controlGroup, control); } // 0xEC3C9B8D5327B563 0x5DE226A5
	static void _0x5B73C77D9EB66E24(BOOL p0) { invoke<Void>(0x5B73C77D9EB66E24, p0); } // 0x5B73C77D9EB66E24
	static float _0x5B84D09CEC5209C5(int controlGroup, int control) { return invoke<float>(0x5B84D09CEC5209C5, controlGroup, control); } // 0x5B84D09CEC5209C5 0xC49343BB
	static BOOL _SET_CONTROL_NORMAL(int controlGroup, int control, float amount) { return invoke<BOOL>(0xE8A25867FBA3B05E, controlGroup, control, amount); } // 0xE8A25867FBA3B05E
	static BOOL IS_DISABLED_CONTROL_PRESSED(int controlGroup, int control) { return invoke<BOOL>(0xE2587F8CBBD87B1D, controlGroup, control); } // 0xE2587F8CBBD87B1D 0x32A93544
	static BOOL IS_DISABLED_CONTROL_JUST_PRESSED(int controlGroup, int control) { return invoke<BOOL>(0x91AEF906BCA88877, controlGroup, control); } // 0x91AEF906BCA88877 0xEE6ABD32
	static BOOL IS_DISABLED_CONTROL_JUST_RELEASED(int controlGroup, int control) { return invoke<BOOL>(0x305C8DCD79DA8B0F, controlGroup, control); } // 0x305C8DCD79DA8B0F 0xD6A679E1
	static float GET_DISABLED_CONTROL_NORMAL(int controlGroup, int control) { return invoke<float>(0x11E65974A982637C, controlGroup, control); } // 0x11E65974A982637C 0x66FF4FAA
	static float _0x4F8A26A890FD62FB(int controlGroup, int control) { return invoke<float>(0x4F8A26A890FD62FB, controlGroup, control); } // 0x4F8A26A890FD62FB 0xF2A65A4C
	static int _0xD7D22F5592AED8BA(int p0) { return invoke<int>(0xD7D22F5592AED8BA, p0); } // 0xD7D22F5592AED8BA 0x0E8EF929
	static BOOL _IS_INPUT_DISABLED(int controlGroup) { return invoke<BOOL>(0xA571D46727E2B718, controlGroup); } // 0xA571D46727E2B718
	static BOOL _IS_INPUT_JUST_DISABLED(int controlGroup) { return invoke<BOOL>(0x13337B38DB572509, controlGroup); } // 0x13337B38DB572509
	...
	static BOOL _0x6CD79468A1E595C6(int controlGroup) { return invoke<BOOL>(0x6CD79468A1E595C6, controlGroup); } // 0x6CD79468A1E595C6
	static char* _GET_CONTROL_ACTION_NAME(int controlGroup, int control, BOOL p2) { return invoke<char*>(0x0499D7B09FC9B407, controlGroup, control, p2); } // 0x0499D7B09FC9B407 0x3551727A
	static char* _0x80C2FD58D720C801(int controlGroup, int control, BOOL p2) { return invoke<char*>(0x80C2FD58D720C801, controlGroup, control, p2); } // 0x80C2FD58D720C801 0x3EE71F6A
...
namespace NETWORK
{
	...
	static BOOL _0x85443FF4C328F53B() { return invoke<BOOL>(0x85443FF4C328F53B); } // 0x85443FF4C328F53B 0x3FB40673
	...
	static void NETWORK_ADD_FOLLOWERS(Any* p0, Any p1) { invoke<Void>(0x236406F60CF216D6, p0, p1); } // 0x236406F60CF216D6 0x0EC62629
	...
	static void NETWORK_UNREGISTER_NETWORKED_ENTITY(Any p0) { invoke<Void>(0x7368E683BB9038D6, p0); } // 0x7368E683BB9038D6 0x5C645F64
	...
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Any p0, Any p1, Any* p2, Any* p3, float p4, float p5, int p6, Any p7, float p8, Any p9) { invoke<Void>(0x742A637471BCECD9, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0x742A637471BCECD9 0xB386713E
	...
	static BOOL TEXTURE_DOWNLOAD_HAS_FAILED(Any p0) { return invoke<BOOL>(0x5776ED562C134687, p0); } // 0x5776ED562C134687 0xE4547765
