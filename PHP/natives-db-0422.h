...
namespace AI
{
	...
	static void TASK_TURN_PED_TO_FACE_COORD(Ped ped, float x, float y, float y, int duration) { invoke<Void>(0x1DDA930A0AC38571, ped, x, y, y, duration); } // 0x1DDA930A0AC38571 0x30463D73
