...
namespace AI
{
	...
	static void TASK_VEHICLE_MISSION_PED_TARGET(Ped ped, Vehicle vehicle, Ped pedTarget, int mode, float maxSpeed, Any drivingStyle, float p6, float p7, BOOL p8) { invoke<Void>(0x9454528DF15D657A, ped, vehicle, pedTarget, mode, maxSpeed, drivingStyle, p6, p7, p8); } // 0x9454528DF15D657A 0xC81C4677
