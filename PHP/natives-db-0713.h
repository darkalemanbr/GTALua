...
namespace OBJECT
{
	...
	static void SET_OBJECT_PHYSICS_PARAMS(Object object, float weight, float p2, float p3, float p4, float p5, float p6, float p7, float p8, float p9, float p10, float density) { invoke<Void>(0xF6DF6E90DE7DF90F, object, weight, p2, p3, p4, p5, p6, p7, p8, p9, p10, density); } // 0xF6DF6E90DE7DF90F 0xE8D11C58
