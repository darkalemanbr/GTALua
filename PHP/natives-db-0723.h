...
namespace PLAYER
{
	...
	static int GET_PLAYER_MAX_ARMOUR(Any* player) { return invoke<int>(0x92659B4CE1863CB3, player); } // 0x92659B4CE1863CB3 0x02A50657
...
namespace ENTITY
{
	...
	static BOOL PLAY_SYNCHRONIZED_ENTITY_ANIM(int entity, Entity syncedScene, char* animation, char* propName, float p4, float p5, Any p6, float p7) { return invoke<BOOL>(0xC77720A12FE14A86, entity, syncedScene, animation, propName, p4, p5, p6, p7); } // 0xC77720A12FE14A86 0x012760AA
...
namespace PED
{
	...
	static void _0x49E50BDB8BA4DAB2(Player p0, BOOL p1) { invoke<Void>(0x49E50BDB8BA4DAB2, p0, p1); } // 0x49E50BDB8BA4DAB2 0x397F06E3
...
namespace OBJECT
{
	...
	static void SET_OBJECT_PHYSICS_PARAMS(Object object, float weight, float p2, float p3, float p4, float p5, float gravity, float p7, float p8, float p9, float p10, float density) { invoke<Void>(0xF6DF6E90DE7DF90F, object, weight, p2, p3, p4, p5, gravity, p7, p8, p9, p10, density); } // 0xF6DF6E90DE7DF90F 0xE8D11C58
...
namespace AI
{
	...
	static void TASK_GO_TO_COORD_ANY_MEANS(Ped ped, float x, float y, float z, float speed, Any p5, BOOL p6, int drivingStyle, float p8) { invoke<Void>(0x5BC448CB78FA3E88, ped, x, y, z, speed, p5, p6, drivingStyle, p8); } // 0x5BC448CB78FA3E88 0xF91DF93B
	static void TASK_GO_TO_COORD_ANY_MEANS_EXTRA_PARAMS(Ped ped, float x, float y, float z, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11) { invoke<Void>(0x1DD45F9ECFDB1BC9, ped, x, y, z, p4, p5, p6, p7, p8, p9, p10, p11); } // 0x1DD45F9ECFDB1BC9 0x094B75EF
...
namespace NETWORKCASH
{
	...
	static int _0x76EF28DA05EA395A() { return invoke<int>(0x76EF28DA05EA395A); } // 0x76EF28DA05EA395A 0x16184FB5
	static int _0xA40F9C2623F6A8B5(int p0) { return invoke<int>(0xA40F9C2623F6A8B5, p0); } // 0xA40F9C2623F6A8B5 0x4F5B781C
